...
<body>
	...
	<div class="container" align="center">
		<div class="col-md-7 col-md-offset-3" style="margin:40px">
			...
			<form class="form-signin" name="memberForm" action="addMember_process.jsp" method="post">
				...
				<div class="form-group row" style="margin: 20px 0;">
					...
					<div class="col-md-6">
						<input type="text" id="id" name="id" class="form-control" placeholder="ID" autocomplete="off" required autofocus/>					
					</div>
				...
				<div class="form-group row" style="margin: 20px 0;">
					...
					<div class="col-md-9">
						<input type="password" name="passwd" class="form-control"	placeholder="Password Check" required/>					
					</div>
				</div>
